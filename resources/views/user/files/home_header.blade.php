                            ...
                            <div class="topbar-left">
                               <div class="position-relative">
                                   <a id="languageDropdownInvoker" class="dropdown-nav-link dropdown-toggle d-flex align-items-center u-header-topbar__nav-link font-weight-normal" href="javascript:;" role="button"
                                       ...
                                       <span class="d-none d-sm-inline-flex align-items-center">@lang('menu.language') <span class="pl-1"><img src="{{ asset('assets/backend/image/flag/small/'.locale()) }}" style="width: 25px;height: 15px"></span></span>
                                   </a>
                            ...
                            <div class="topbar-right ml-auto">
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                        <a href="../home/contact-v2.html" class="u-header-topbar__nav-link"><i class="ec ec-map-pointer mr-1"></i>@lang('menu.store_locator')</a>
                                    </li>
                                    <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                                   ...
                                                   <a  href="{{ route('customer.dashboard') }}" class="u-header-topbar__nav-link p-2"
                                                    ...
                                                    <a  href="javascript:;" role="button" class="u-header-topbar__nav-link p-2"
                                                       onclick="event.preventDefault();
                                                         document.getElementById('logout-form-admin').submit();"><br>
                                 ...
                                 <form class="js-focus-state" action="{{ route('product_search') }}" method="post">
                                  @csrf
                                    ...
                                    <div class="input-group">
                                        <input id="transcript" type="text" class="form-control py-2 pl-5 font-size-15 border-right-0 height-40 border-width-2 rounded-left-pill border-primary" name="search_key" id="searchproduct-item" placeholder="@lang('title.search_product')" aria-label="Search for Products" aria-describedby="searchProduct1">
                                        <div class="input-group-append">
                                            <!-- Select -->
                                            <select class="js-select selectpicker dropdown-select custom-search-categories-select"
                                                data-style="btn height-40 text-gray-60 font-weight-normal border-top border-bottom border-left-0 rounded-0 border-primary border-width-2 pl-0 pr-5 py-2" name="c">
                                                <option value="">@lang('title.all_category')</option>
                                                @php
                                           ...
                                           {{--  <button onclick="startDictation()" class="btn btn-primary height-40 py-2 px-3 rounded-right-pill" type="button">
                            ...
                            <div class="col col-xl-auto text-right text-xl-left pl-0 pl-xl-3 position-static">
                                <div class="d-inline-flex">
                                    <ul class="d-flex list-unstyled mb-0 align-items-center">
                                        ...
                                        <li class="col d-none d-xl-block"><a href="{{ route('view.comparelist') }}" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="@lang('title.compare')"><i class="font-size-22 ec ec-compare"></i></a></li>

                                       

                                       {{--  @if (Auth::check() && (Auth::user()->user_type == 'customer')) --}}
                                         <li class="col d-none d-xl-block"><a href="{{ route('view.wishlist') }}" class="text-gray-90" data-toggle="tooltip" data-placement="top" title="@lang('title.favorite')"><i class="font-size-22 ec ec-favorites"></i></a></li>
                                        ...
                                        {{--  @else --}}
                                         ...
                                         {{-- <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                             ...
                                             <a id="sidebarNavToggler" href="javascript:;" role="button" class="u-header-topbar__nav-link"
                                                 ...
                                                 data-unfold-animation-out="fadeOutRight"
                                                 data-unfold-duration="500">
                                                 <i class="ec ec-user mr-1"></i> Wishlist
                                             </a>
                                                        ...
                                                        <ul class="navbar-nav u-header__navbar-nav">
                                                            ...
                                                            @foreach ($categories as $category)
                                                                ...
                                                                <div class="hs-mega-menu vmm-tfw u-header__sub-menu" aria-labelledby="basicMegaMenu">
                                                                    <div class="vmm-bg">
{{-- <img class="img-fluid" src="{{ $category->image !=null ?asset('assets/backend/image/category/small/'.$category->image) :asset('assets/backend/image/'.default_image()) }}" alt="Image Description"> --}}
                                                                    </div>
                                ...
                                <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                    <ul class="navbar-nav u-header__navbar-nav">
                                        ...
                                        <li class="nav-item u-header__nav-item">
                                            <a class="nav-link u-header__nav-link" href="{{ route('home.page') }}">@lang('menu.home')</a>
                                        </li>

                                        <li class="nav-item u-header__nav-item">
                                            <a class="nav-link u-header__nav-link" href="{{ route('product.shop') }}">@lang('menu.shop')</a>
                                        </li>
