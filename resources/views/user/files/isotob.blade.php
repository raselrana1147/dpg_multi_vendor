                                            ...
                                            <div class="product-item__outer h-100 w-100 prodcut-box-shadow">
                                                <div class="product-item__inner bg-white p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img class="img-fluid" src="{{ asset('assets/frontend/assets/img/212X200/img2.jpg')}}" alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                                <div class="text-gray-100">$685,00</div>
                                            ...
                                            <div class="product-item__outer h-100 w-100 prodcut-box-shadow">
                                                <div class="product-item__inner bg-white p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img class="img-fluid" src="{{ asset('assets/frontend/assets/img/212X200/img7.jpg')}}" alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                                <div class="text-gray-100">$685,00</div>
                                                ...
                                                <div class="product-item__inner bg-white p-3">
                                                    <div class="product-item__body d-flex flex-column">
                                                        ...
                                                        <div class="mb-1 min-height-4-1-4">
                                                            <a href="#" class="d-block text-center my-4 mt-lg-6 mb-lg-5 mt-xl-0 mb-xl-0 mt-wd-6 mb-wd-5"><img class="img-fluid" src="{{ asset('assets/frontend/assets/img/564X520/img2.jpg')}}" alt="Image Description"></a>
                                                            <!-- Gallery -->
                                                            <div class="row mx-gutters-2 mb-3">
                                                                <div class="col-auto">
                                                                    ...
                                                                    <a class="js-fancybox max-width-60 u-media-viewer" href="javascript:;"
                                                                        ...
                                                                        <img class="img-fluid border" src="{{ asset('assets/frontend/assets/img/100X100/img1.jpg')}}" alt="Image Description">
                                                                ...
                                                                <div class="col-auto">
                                                                    <!-- Gallery -->
                                                                    <a class="js-fancybox max-width-60 u-media-viewer" href="javascript:;"
                                                                        data-src="{{ asset('assets/frontend/assets/img/1920X1080/img2.jpg')}}"
                                                                        data-fancybox="fancyboxGallery6"
                                                                        data-caption="Electro in frames - image #02"
                                                                        data-speed="700"
                                                                        data-is-infinite="true">
                                                                        <img class="img-fluid border" src="{{ asset('assets/frontend/assets/img/100X100/img2.jpg')}}" alt="Image Description">
                                                                ...
                                                                <div class="col-auto">
                                                                    <!-- Gallery -->
                                                                    <a class="js-fancybox max-width-60 u-media-viewer" href="javascript:;"
                                                                        data-src="{{ asset('assets/frontend/assets/img/1920X1080/img3.jpg')}}"
                                                                        data-fancybox="fancyboxGallery6"
                                                                        data-caption="Electro in frames - image #03"
                                                                        data-speed="700"
                                                                        data-is-infinite="true">
                                                                        <img class="img-fluid border" src="{{ asset('assets/frontend/assets/img/100X100/img3.jpg')}}" alt="Image Description">
                                                        ...
                                                        <div class="mb-1 min-height-4-1-4">
                                                            ...
                                                            <div class="row mx-gutters-2 mb-3">
                                                                <div class="col-auto">
                                                                    <!-- Gallery -->
                                                                    <a class="js-fancybox max-width-60 u-media-viewer" href="javascript:;"
                                                                        data-src="{{ asset('assets/frontend/assets/img/1920X1080/img1.jpg')}}"
                                                                        data-fancybox="fancyboxGallery6"
                                                                        data-caption="Electro in frames - image #01"
                                                                        data-speed="700"
                                                                        data-is-infinite="true">
