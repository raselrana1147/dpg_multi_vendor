@extends('layouts.app')
@section('ecommerce_title','Ecommerce | Brand Products')
	            ...
	            <div class="mb-6 d-none d-xl-block">
	                <div class="position-relative">
	                    <div class="border-bottom border-color-1 mb-2">
	                        <h3 class="d-inline-block section-title section-title__full mb-0 pb-2 font-size-22">@lang('title.recommended_for_your')</h3>
	                    </div>
	                                ...
	                                <div class="product-item__outer h-100">
	                                    <div class="product-item__inner px-wd-4 p-2 p-md-3">
	                                        <div class="product-item__body pb-xl-2">
	                                            ...
	                                            <h5 class="mb-1 product-item__title"><a href="{{ route('product.detail',$recommended->slug) }}" class="text-blue font-weight-bold">{{$recommended->name}}</a></h5>
	                                            <div class="mb-2">
	                                        ...
	                                        <div class="product-item__footer">
	                                            <div class="border-top pt-2 flex-center-between flex-wrap ">
	                                                <a data-action="{{ route('add_to_comparelist') }}" product_id="{{$recommended->id}}" href="javascript:;" class="text-gray-6 font-size-13 add_to_comparelist"><i class="ec ec-compare mr-1 font-size-15"></i>@lang('title.compare')</a>

	                                                <a href="javascript:;" class="text-gray-6 font-size-13 add_to_wishlist" data-action="{{ route('add_to_wishlist') }}" product_id="{{$recommended->id}}"><i class="ec ec-favorites mr-1 font-size-15"></i>@lang('title.add_to_Wishlist')</a>
	                            ...
	                            <div class="product-item__outer h-100">
	                                <div class="product-item__inner px-xl-4 p-3">
	                                    <div class="product-item__body pb-xl-2">
	                                        ...
	                                        <div class="flex-center-between mb-1">
	                                            <div class="prodcut-price">
	                                                <div class="text-gray-100">{{currency()}}{{number_format($product->current_price,2)}}</div>
	                                            </div>
	                                            <div class="d-none d-xl-block prodcut-add-cart">
	                                    ...
	                                    <div class="product-item__footer">
	                                        <div class="border-top pt-2 flex-center-between flex-wrap">
	                                            <a href="javascript:;" product_id="{{$product->id}}" data-action="{{ route('add_to_comparelist') }}"class="text-gray-6 font-size-13 add_to_comparelist"><i class="ec ec-compare mr-1 font-size-15"></i>@lang('title.compare')</a>
	                                            <a href="javascript:;" product_id="{{$product->id}}" data-action="{{ route('add_to_wishlist') }}"class="text-gray-6 font-size-13 add_to_wishlist"><i class="ec ec-favorites mr-1 font-size-15"></i>@lang('title.add_to_Wishlist')</a>
	                                        </div>
	                                    </div>
	                                </div>
	                            </div>
	                            ...
	                            <div class="product-item__outer w-100">
	                                <div class="product-item__inner remove-prodcut-hover py-4 row">
	                                    ...
	                                    <div class="product-item__body col-6 col-md-5">
	                                        <div class="pr-lg-10">
	                                            <div class="mb-2"><a href="{{ route('product.category_wise',$product->id) }}" class="font-size-12 text-gray-5">{{$product->category->category_name}}</a></div>
	                                            ...
	                                            <ul class="font-size-12 p-0 text-gray-110 mb-4 d-none d-md-block">
	                                                {!!short_description($product->description,0,200)!!}
	                                            </ul>
	                                        </div>
	                                    </div>
	                                    <div class="product-item__footer col-md-3 d-md-block">
	                                        <div class="mb-3">
	                                            ...
	                                            <div class="prodcut-add-cart">
	                                                <a href="{{ route('product.detail',$product->slug) }}" class="btn btn-sm btn-block btn-primary-dark btn-wide transition-3d-hover">@lang('title.add_to_cart')</a>
	                                            </div>
	                                        </div>
	                                        <div class="flex-horizontal-center justify-content-between justify-content-wd-center flex-wrap">
	                                            <a href="javascript:;" product_id="{{$product->id}}" data-action="{{ route('add_to_comparelist') }}"class="text-gray-6 font-size-13 mx-wd-3 add_to_comparelist"><i class="ec ec-compare mr-1 font-size-15"></i>@lang('title.compare')</a>
	                                            <a href="javascript:;" product_id="{{$product->id}}" data-action="{{ route('add_to_wishlist') }}"class="text-gray-6 font-size-13 mx-wd-3 add_to_wishlist"><i class="ec ec-favorites mr-1 font-size-15"></i>@lang('title.add_to_Wishlist')</a>
	                                        </div>
	                                    </div>
	                                </div>
	                            </div>
