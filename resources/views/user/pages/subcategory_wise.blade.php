@extends('layouts.app')
@section('ecommerce_title','Ecommerce | Sub Category Products')
	            ...
	            <nav aria-label="breadcrumb">
	                <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
	                    ...
	                    <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">
	                    	<a href="{{ route('product.subcategory_wise',$subcategory->id) }}">{{$subcategory->category_name}}</a>
	                    	</li>
	                </ol>
	            </nav>
	        </div>
	...
	<div class="container">
	    <div class="mb-6">
	        <div class="d-flex justify-content-between align-items-center border-bottom border-color-1 flex-lg-nowrap flex-wrap mb-4">
	            <h3 class="section-title section-title__full mb-0 pb-2 font-size-22">{{$subcategory->category_name}}</h3>
	        </div>
	        <ul class="row list-unstyled products-group no-gutters mb-6 sell_subcategory_product" page_num_subcat="1" sub_category_id="{{$subcategory->id}}">
	        ...
	        <div class="position-relative">
	            <div class="border-bottom border-color-1 mb-2">
	                <h3 class="section-title section-title__full d-inline-block mb-0 pb-2 font-size-22">@lang('title.customer_sub_buying')</h3>
	            </div>
