@extends('layouts.app')
@section('ecommerce_title','Ecommerce | Category Products')
	            ...
	            <nav aria-label="breadcrumb">
	                <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
	                    ...
	                    <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">
	                    	<a href="{{ route('product.category_wise',$category->id) }}">{{$category->category_name}}</a>
	...
	<div class="container">
	    <div class="mb-6">
	        <div class="d-flex justify-content-between align-items-center border-bottom border-color-1 flex-lg-nowrap flex-wrap mb-4">
	            <h3 class="section-title section-title__full mb-0 pb-2 font-size-22">{{$category->category_name}}</h3>
	        </div>
	        <ul class="row list-unstyled products-group no-gutters mb-6 sell_category_product" page_num_cat="1" category_id="{{$category->id}}">
