...
@section("seller_title","DPG Seller | Monthly Report")
@section("seller_breadcrumb",trans('seller.monthly_report'))
      ...
      <div class="col-12">
          <div class="card">
              <div class="card-body">
                   ...
                   <h4 class="mt-0 header-title">@lang('seller.monthly_report')</h4>
