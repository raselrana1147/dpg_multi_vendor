...
@section("seller_breadcrumb",trans('seller.update_profile'))
  ...
  <div class="col-8 offset-2">
    <div class="card">
        <div class="card-body">
            ...
            <form id="submit_form" class="custom-validation" data-action="{{ route('seller.profile_update') }}"  method="POST" enctype="multipart/form-data">
             @csrf
                ...
                <div class="form-group">
                    <label>@lang('seller.first_name')</label>
                    <input type="text" class="form-control" name="first_name" required placeholder="@lang('seller.enter_first_name')" value="{{$seller->first_name}}" />
                </div>

                <div class="form-group">
                    <label>@lang('seller.last_name')</label>
                    <input type="text" class="form-control" name="last_name" required value="{{$seller->last_name}}" placeholder="@lang('seller.enter_last_name')"/>
                </div>
                <div class="form-group">
                    <label>@lang('seller.phone')</label>
                    <input type="text" class="form-control" name="phone" value="{{$seller->phone}}" required placeholder="@lang('seller.enter_phone')"/>
                </div>
                ...
                <div class="form-group">
                   <div class="js-form-message mb-4">
                       ...
                       <div class="custom-control custom-radio custom-control-inline">
                         <input type="radio" id="radioMale" name="gender" class="custom-control-input" {{$seller->gender=="Male" ? 'checked' : ''}} value="Male">
                         <label class="custom-control-label" for="radioMale">@lang('title.male')</label>
                       </div>
                       <div class="custom-control custom-radio custom-control-inline">
                         <input type="radio" id="radioFemale" name="gender" class="custom-control-input" {{$seller->gender=="Female" ? 'checked' : ''}} value="Female">
                         <label class="custom-control-label" for="radioFemale">@lang('title.female')</label>
                       </div>

                       <div class="custom-control custom-radio custom-control-inline">
                         <input type="radio" id="radionOther" name="gender" class="custom-control-input" {{$seller->gender=="Other" ? 'checked' : ''}} value="Other">
                ...
                <div class="form-group">
                   ...
                   <textarea class="form-control" name="address" cols="20" rows="4" placeholder="@lang('seller.enter_address')">{{$seller->address}}</textarea>
                </div>
