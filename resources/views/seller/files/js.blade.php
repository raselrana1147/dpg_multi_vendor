       <script src="{{ asset('assets/backend/assets/js/jquery.min.js')}}"></script>
        ...
        <script src="{{ asset('assets/backend/plugins/datatables/responsive.bootstrap4.min.js')}}"></script>
         ...
         <script src="{{ asset('assets/style/js/dropify.js')}}"></script>
         <script src="{{ asset('assets/style/js/dropify.more.js')}}"></script>
          <script src="{{ asset('assets/style/js/toastr.js')}}"></script>
          <script src="{{ asset('assets/style/js/sweet-alert.js')}}"></script>
          <script src="{{ asset('assets/style/js/seller_custom.js')}}"></script>
