...
@section("title","DPG Admin | Size Update")
@section("breadcrumb",trans('admin.size_update'))
@section("content")
                   ...
                   <form id="submit_form" class="custom-validation" data-action="{{ route('admin.size_update') }}"  method="POST">
                    @csrf
                       ...
                       <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="size_name" required value="{{$data->size_name}}"  placeholder="@lang('admin.size_name')" />
                       </div>

                       <div class="form-group">
                           <label>@lang('admin.size_code')</label>
                           <input type="text" class="form-control" name="size" required value="{{$data->size}}" placeholder="@lang('admin.size_code')" />
                       </div>
