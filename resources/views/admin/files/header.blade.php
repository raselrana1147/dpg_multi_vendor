                ...
                <div class="topbar-left">
                    <a href="{{ route('admin.dashboard') }}" class="logo">
                        <span class="logo-light">
                            <img src="{{ asset('assets/backend/image/logo/'.logo())}}" alt="" height="16">
                        </span>
                        <span class="logo-sm">
                            <img src="{{ asset('assets/backend/image/logo/'.logo())}}" alt="" height="22">
                        </span>
                    </a>
                </div>
                        ...
                        <li class="dropdown notification-list list-inline-item">
                                    <div class="dropdown notification-list nav-pro-img">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                            <!-- item-->
                                            <a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="mdi mdi-account-circle"></i> @lang('admin.update_profile')</a>
                                            <a class="dropdown-item" href="{{ route('admin.change_password') }}"><i class="mdi mdi-wallet"></i>@lang('admin.change_password')</a>
                
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item text-danger" href="javascript:;" onclick="event.preventDefault();
                                               document.getElementById('logout-form-admin').submit();">
                                                <i class="mdi mdi-power text-danger"></i> @lang('admin.logout')</a>
