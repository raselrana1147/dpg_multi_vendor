        ...
        <link href="{{ asset('assets/style/css/dropify.css')}}" rel="stylesheet" type="text/css">
        <link href="{{ asset('assets/style/css/toastr.css')}}" rel="stylesheet" type="text/css">
        <link href="{{ asset('assets/backend/style/css/style.css')}}" rel="stylesheet" type="text/css">
        @yield('css')