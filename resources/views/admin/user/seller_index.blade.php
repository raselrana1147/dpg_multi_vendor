...
@section("title","DPG Admin | Seller List")
@section("breadcrumb",trans('admin.seller_list'))
@section("content")
   <div class="row">
       <div class="col-12">
           <div class="card">
               <div class="card-body">
                    ...
                    <h4 class="mt-0 header-title">@lang('admin.seller_list')</h4>
