...
@section("title","DPG Admin | Color Update")
@section("breadcrumb",trans('admin.color_update'))
@section("content")
                   ...
                   <form id="submit_form" class="custom-validation" data-action="{{ route('admin.color_update') }}"  method="POST">
                    @csrf
                       ...
                       <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="color_name" required value="{{$data->color_name}}" />
                       </div>

                       <div class="form-group">
                           <label>@lang('admin.color_code')</label>
                           <input type="text" class="form-control" name="color_code" required value="{{$data->color_code}}"/>
                       </div>
