...
@section("title","DPG Admin | Change Password")
@section("breadcrumb",trans('admin.change_password'))
@section("content")
     ...
     <div class="col-8 offset-2">
       <div class="card">
           <div class="card-body">
               ...
               <form id="submit_form" class="custom-validation" data-action="{{ route('admin.update_password') }}"  method="POST">
                @csrf
                   <div class="form-group">
                       <label>@lang('seller.old_password')</label>
                       <input type="password" class="form-control" name="old_password" required placeholder="@lang('admin.enter_old_password')"/>
                   </div>

                   <div class="form-group">
                       <label>@lang('seller.new_password')</label>
                       <input type="password" class="form-control" name="new_password" required placeholder="@lang('admin.enter_new_password')"/>
                   </div>
                    <div class="form-group">
                       <label>@lang('seller.confirm_password')</label>
                       <input type="password" class="form-control" name="password_confirmation" required placeholder="@lang('admin.enter_confirm_password')"/>
                   </div>
