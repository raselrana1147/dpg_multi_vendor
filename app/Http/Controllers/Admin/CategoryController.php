...
class CategoryController extends Controller
{
    ...
    {
       $datas=Category::whereNull('parent_id')->orderBy('id','DESC')->get();
    ...
    {
        $datas=Category::whereNotNull('parent_id')->latest()->get();
    ...
    {
      return view('admin.category.sub_cat_index');
    }
    ...
    public function edit_sub($id)
    {
      $categories=Category::whereNull('parent_id')->get();
       $data=Category::findOrFail($id);
       return view('admin.category.edit_sub',compact('data','categories'));
    }
